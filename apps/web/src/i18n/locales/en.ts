...
export const en = {
  ...
  teamBuilder: {
    list: {
      heading: 'Your teams',
      new: 'New team',
      empty: 'No teams yet — draft your first roster.',
      players: '{{n}} players',
      delete: 'Delete',
      deleteTitle: 'Delete this team?',
      deleteBody: 'This permanently removes “{{name}}”. It can’t be undone.',
    ...
    builder: {
      ...
      chooseTeam: 'Roster',
      choosePlaceholder: 'Choose a roster…',
      pickTeamFirst: 'Choose a roster to start drafting.',
      positions: 'Positions',
      roster: 'Roster',
      emptyRoster: 'No players yet — add them from the positions list.',
    ...
    status: {
      legal: 'Roster is legal',
      incomplete: 'Roster incomplete',
      issues: 'Roster has issues',
    },
    diagnostics: {
      'unknown-position': 'Unknown position “{{position}}”.',
      'position-limit': 'Too many {{position}} — {{actual}} of {{limit}}.',
      'too-few-players': 'Under strength — {{actual}} of {{limit}} players.',
      'too-many-players': 'Too many players — {{actual}}, max {{limit}}.',
      'reroll-limit': 'Too many re-rolls — {{actual}}, max {{limit}}.',
      'apothecary-not-allowed': 'This team can’t hire an apothecary.',
      'assistant-coach-limit':
        'Too many assistant coaches — {{actual}}, max {{limit}}.',
      'cheerleader-limit': 'Too many cheerleaders — {{actual}}, max {{limit}}.',
      'dedicated-fans-limit':
        'Too many dedicated fans — {{actual}}, max {{limit}}.',
      'over-budget': 'Over budget — {{actual}} of {{limit}}.',
    },
    toast: {
      saved: 'Team saved.',
      deleted: 'Team deleted.',
      saveError: 'Could not save the team.',
      loadError: 'Could not load your teams.',
    },
  },
  ref: {
    kind: {
