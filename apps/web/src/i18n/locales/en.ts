...
export const en = {
  ...
  teamBuilder: {
    ...
    page: {
      ...
      squad: 'Squad',
      emptyRoster: 'This team has no players yet.',
      profile: 'Profile',
      skills: 'Skills',
      spp: 'SPP',
      value: 'Value',
      ...
      manage: 'Manage',
      level: 'Level {{n}}',
      addSpp: 'Star Player Points',
      sppBanked: 'banked',
      advance: 'Advance',
      randomPrimary: 'Random primary · {{spp}} SPP',
      randomSecondary: 'Random secondary · {{spp}} SPP',
      chooseSkill: 'Choose a skill…',
      learn: 'Learn',
      learnFor: 'Learn · {{spp}} SPP',
      chooseStat: 'Choose a characteristic…',
      improveFor: 'Improve · {{spp}} SPP',
