...
export const fr = {
  ...
  teamBuilder: {
    ...
    builder: {
      ...
      chooseTeam: 'Équipe',
      choosePlaceholder: 'Choisissez une équipe…',
      pickTeamFirst: 'Choisissez une équipe pour commencer.',
      positions: 'Postes',
      roster: 'Effectif',
      emptyRoster: 'Aucun joueur — ajoutez-en depuis la liste des postes.',
    ...
    page: {
      ...
      squad: 'Effectif',
      emptyRoster: 'Cette équipe n’a pas encore de joueurs.',
      profile: 'Profil',
      skills: 'Compétences',
      spp: 'PEV',
      value: 'Valeur',
      ...
      manage: 'Gérer',
      level: 'Niveau {{n}}',
      addSpp: 'Points d’Étoile',
      sppBanked: 'en réserve',
      removeSpp: 'Retirer un point',
      advance: 'Progression',
      chooseSkill: 'Choisissez une compétence…',
      learn: 'Apprendre',
      learnFor: 'Apprendre · {{spp}} PEV',
      chooseStat: 'Choisissez une caractéristique…',
      improveFor: 'Améliorer · {{spp}} PEV',
